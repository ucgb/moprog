package com.maulana.catatanpenjualan.activity.penjualan
...
import com.maulana.catatanpenjualan.activity.penjualan.adapter.PenjualanAdapter
import com.maulana.catatanpenjualan.activity.penjualan.presenter.PenjualanPresenter
import com.maulana.catatanpenjualan.activity.penjualan.presenter.PenjualanView
...
import com.maulana.catatanpenjualan.model.Penjualan
...
class PenjualanBarang : BaseActivity(), PenjualanView {
    ...
    private fun setAction() {
        ...
        etSearchBarang.addTextChangedListener1 {
    ...
    override fun onSuccessSearchItem(barangs: List<Barang?>?) {
        ...
        lvResultSearch.adapter = ArrayAdapter<String?>(this, android.R.layout.simple_list_item_1, onlyName!!)
